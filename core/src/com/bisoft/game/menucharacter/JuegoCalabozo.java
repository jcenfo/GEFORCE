...
public class JuegoCalabozo implements Screen {
    private Render render;
    private Inputs input;
    //private Pantalla screen;

    private Texture guerrero, mago, mercenario, fondoJardin;
    ...
    public JuegoCalabozo() {
        ...
        fondoJardin = new Texture("assets/rooms/FondoJardin.jpeg");
...
//        render.Batch.draw(mago, 550, 250);
        render.Batch.draw(fondoJardin, 0, 0);
        render.Batch.end();
        validateKeys();
    }
...
//        this.options.add(new Text("Mago", mFontSize, Resources.GAME_FONT));
        this.options.add(new Text("fondoJardin", mFontSize, Resources.GAME_FONT));
