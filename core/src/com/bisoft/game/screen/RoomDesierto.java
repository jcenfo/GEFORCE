...
public class RoomDesierto implements Screen {
    ...
    public RoomDesierto() {
        ...
        player = new Player(atlas, 765, 320, this.screen.getWorld());
        screen.getWorld().setContactListener(new WorldContactListener());
        this.gameName = new Text(Resources.GAME_FONT, 320, 590, 20, "Room desierto");
