...
public class BuilderCenfomonedas  extends AComponenteProducto {
    public BuilderCenfomonedas(){
        this.setIndice(2);
    }
    ...
    @Override
    public void construirComponente(int pValor) throws Exception {
        this.set_Componente(new Cenfomonedas(pValor));
