package proxy.src.Proxy.Main;

import proxy.src.Proxy.Implementacion.DocumentoProxyAlumno;
import proxy.src.Proxy.Implementacion.DocumentoProxyProfesor;
...
public class Gestor_Proxy {
	...
	private void CambiarProxy() {		
		switch (this.get_TipoProxy()){
			...
			case 2:
				_ProxyDocument = (IDocumento) new DocumentoProxyAlumno();
				break;
		}
	}
	 ...
	 */
	private void set_TipoProxy(int _TipoProxy) {
